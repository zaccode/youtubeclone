...
import ytLogo from "../images/logo/yt-logo.png";
import ytLogoMobile from "../images/logo/yt-logo-mobile.png";
  ...
  return (
    <div className="sticky top-0 z-10 flex flex-row items-center justify-between h-14 px-4 md:px-5 bg-white dark:bg-black">
        ...
        <div className="group flex items-center">
            <div className="flex h-8 md:h-10 md:ml-10 md:pl-5 border- [#303030 rounded-l-3xl group-focus-within:border-blue-500 md:group-focus-within:pl-0">
